...
public class TestCircle {
	...
	public static void main(String[] args) {
		...
		System.out.println("The 1 circle has radius of " + c1.getRadius() + " and area of " + c1.getArea());
		...
		System.out.println("The 2 circle has radius of " + c2.getRadius() + " and area of " + c2.getArea());
		Circle c3 = new Circle(); // construct an instance of Circle
		c3.setRadius(5.0); // change radius
		c3.setColor("Transparent");
		System.out.println("The 3 circle has radius of " + c3.getRadius() + " and area of " + c3.getArea() + " and the color is"
				+ c3.getColor()); // change color
