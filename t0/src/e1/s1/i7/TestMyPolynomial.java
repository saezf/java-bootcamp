...
public class TestMyPolynomial {
	...
	public static void main(String[] args) {
		...
		MyPolynomial p3 = new MyPolynomial("src/s1/i7/testfile1.txt");
		System.out.println("Polynomial p3: " + p3 + "  From file loaded directly from a string");

		String path = OpenPolynomialFile().getPath();
		// Yes I know i would be a lot easier to overload the builder to pass a
		// file instead of a string with the path of the file
		if (path != null) {
			try {
			...
			System.out.println("Polynomial p3x: " + p3 + "\nif you didn't see the window forget this Polynomial");
		}
	...
	public static File OpenPolynomialFile() {
		...
		fileChooser.setCurrentDirectory(new File(System.getProperty("user.dir") + "/src/s1/i7")); // \t0e1\src\s1\i7
