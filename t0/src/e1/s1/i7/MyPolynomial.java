...
public class MyPolynomial {
	...
	public MyPolynomial(String filename) {
		...
		try {
			...
			// I didn't understand why would you try to run Scanner.nextLine()
			// after you fail to open the file so i moved it
	...
	public MyPolynomial add(MyPolynomial another) {
		...
		// iterates the polynomial with the smaller degree adding each element
		// to the auxiliary
	...
	public MyPolynomial multiply(MyPolynomial another) {
		...
		for (int mine = 0; mine < this.coeffs.length; mine++) // iterates
																// this.coeffs
		{
			for (int other = 0; other < arg.length; other++) // iterates
																// another.coeffs
			{
