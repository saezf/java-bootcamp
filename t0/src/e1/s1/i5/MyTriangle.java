...
public class MyTriangle {
	...
	public String printType() {
		...
		// return (edge1 == edge2 && edge2 == edge3) ? "Equilateral" : ((edge1
		// == edge2 || edge1 == edge3 || edge2 == edge3) ? "Isosceles" :
		// "Scalene" );

		if (Double.compare(edge1, edge2) + Double.compare(edge2, edge3) == 0) {
			return "Equilateral";
		} else {
			if (Double.compare(edge1, edge2) == 0 || Double.compare(edge2, edge3) == 0 || Double.compare(edge1, edge3) == 0) {
				return "Isosceles";
			} else {
				return "Scalene";
			}
