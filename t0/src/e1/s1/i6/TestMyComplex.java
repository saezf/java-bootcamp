...
public class TestMyComplex {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println(complex.toString() + " is " + complex.equals(complex2.getReal(), complex2.getImag()) + " equal to "
				+ complex2.toString() + " // method(double, double)");
		System.out.println(complex.toString() + " is " + complex.equals(complex2) + " equal to " + complex2.toString()
				+ " // method(mycomplex another)");
		System.out.println("equals (double,double): " + complex.toString() + " == " + complex2.toString() + ": "
				+ complex.equals(complex2.getReal(), complex2.getImag()));
		System.out.println("equals (mycomplex another): " + complex.toString() + " == " + complex2.toString() + ": "
